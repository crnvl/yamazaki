...
public class NeutralCount {

    private static Properties properties;
    static File file = new File("neutrals.properties");
    ...
    public static void save(String hash, String name) {
        ...
        try {
            properties.store(new FileOutputStream(file), "Yamazaki Neutral Word Counts");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    private static void fileNotFoundAction(File f){
        try {
            properties.store(new FileOutputStream(f), "Yamazaki Neutral Word Counts");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
